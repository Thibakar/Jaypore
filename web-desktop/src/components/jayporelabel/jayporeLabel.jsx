            ...
            <div className="col-md-7">
              ...
              <div className="row">
                ...
                <div className="col-md-4  background-color-pink p-l-3 ">
                  <div className="font-size-18 text-212121 m-t-22 a-sb-txt p-b-23 ">
                    COLLECTION
          </div>
                  {this.state.Collection.map(i => (
                    <div className="font-14  p-b-23  a-r-txt">
                  ...
                  <div className="font-size-18 text-212121 color-red m-t-22 a-sb-txt p-b-23 ">
                    SUMMER SALE
          </div>
                ...
                <div className="col-md-4 width-268 background-color-pink p-l-3">
                  <div className="font-size-18 text-212121 p-b-23  m-t-22 a-sb-txt">
                    SAREES
          </div>
                  {this.state.Sarees.map(i => (
                    <div className="font-14 text-212121 p-b-23 a-r-txt">
                      <Link className="text-212121" to="/categoryListing">
                        {i.name}
                      </Link>
                    </div>
                  ...
                  <div className="font-size-18 text-212121 p-b-23 a-sb-txt">
                    CLOTHING
          </div>
                ...
                <div className="col-md-4 width-268 background-color-pink p-l-3">
                  ...
                  <div className="font-size-18 text-212121 p-b-23 a-sb-txt">SHAWLS</div>
                  ...
                  <div className="font-size-18 color-red text-212121 p-b-23  m-t-22 a-sb-txt">
                    OUR SALE FAVOURITES
          </div>
