        ...
        <div className="label-container mt-4">
          {
            parseInt(handlePosition[0]) === 0 ?
              <label className="text-left a-14-txt a-r-txt a-colr-21">Rs: 00 - Rs: 290,000</label>
              :
              <label className="text-left a-14-txt a-r-txt a-colr-21">Rs: {this.format(handlePosition[0])} - {this.format(handlePosition[1])}<span>{unit}</span></label>
          }
          {/* {
            parseInt(handlePosition[1]) === 100 ?
              <label></label>
              :
              <label className="text-left">Rs: {this.format(handlePosition[1])}<span>{unit}</span></label>
          } */}
        </div>
      </div>
    );
