...
class CategorySpecialCard2 extends Component {
    constructor (props) {
        super(props)
        this.state = {
            ...
            dataSet2:[
                ...
                {
                    imgurl:"https://static.jaypore.com/tr:w-392,h-/media/catalog/product/e/k/ekyapsamcnajp61-1.jpg",
                     name:"JAYPORE",
                    color:"Ivory-Blue Handsome Cotton",
                    rupess:"Rs. 2290",
                    offer:"Rs. 3330",
...
<div className="col-md-12 cl-plr-0">
                            <div className="category-special-card-large" onClick={() => this.props.onClickItem()}>
                                <div className="cl-position-relative">
                                    <img className="category-special-fav-icon-large" src={favicon} alt="fav-icon" />
                                    <img className="category-special-similar-icon-large" src={similaricon} alt="similar-icon" />
                                    <img className="category-special-readytoship-icon-large" src={readyToShip} alt="readytoship-icon" />
                                    <img className="category-special-card-img cl-br-5" src={i.imgurl} alt="category-listing-card" />
                    ...
                    {this.state.dataSet.map((i) =>
                        (
                            ...
                            <div className=" category-special-card-small" onClick={() => this.props.onClickItem()}>
                            <div className="cl-position-relative">
                                    ...
                                    <img className="category-list-card-img cl-br-5" src={i.imgurl} alt="category-listing-card" />
                                </div>
                                <div>
                                    <h6 className=" dress-name ">{i.name}</h6>
                                    <p className=" clr-name  category-dress-color">{i.color}</p>
...
export default CategorySpecialCard2;