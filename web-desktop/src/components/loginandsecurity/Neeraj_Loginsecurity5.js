...
class Neeraj_Loginsecurity5 extends React.Component {
    render(){
        return(
            <div>
            ...
            <div class="desktop-outer-grid2">
              <div id="desktop-inner-grid2">
                <div class="row">
                    ...
                    <b class="desktop-coupons-text2">Name</b>
                    <button class="desktop-ls1-button2">Edit</button><br/>
              ...
              <div id="desktop-inner-grid12">        <div class="row">
                  ...
                  <input type="desktop-login-text2" placeholder="+91 9773778575"></input><br/>
                   <a href="#popup3" ><button class="desktop-login-button2">Otp Verify To Save</button></a>
              ...
              <div id="desktop-inner-grid4">        <div class="row">
                  ...
                  <b class="desktop-coupons-text2">Password:</b>
                  <button class="desktop-ls1-button2">Edit</button><br/>
	...
	<div class="desktop-login-popup">
    <a class="close1" href="#">×</a>
        <br/><br/>
<b class="desktop-ls5-text1">OTP Sent</b><br/><br/>
<a class="desktop-ls5-text2">OTP has been sent successfully to 9773778575</a>
	</div>
...
export default Neeraj_Loginsecurity5