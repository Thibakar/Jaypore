...
class Neeraj_Loginsecurity6 extends React.Component {
    render(){
        return(
            <div>
          ...
          <div class="desktop-outer-grid1"><br />
            <b class="desktop-coupons-text1">Login & Security</b>
            <hr class="desktop-sa2-heading"></hr>
            <div class="desktop-outer-grid2">
              <div id="desktop-inner-grid2">
                <div class="row">
                  
                    <b class="desktop-coupons-text2">Name</b><br/>
                    <a class="desktop-coupons-text2">Shahnawaz Alam</a>
                    <button class="desktop-ls1-button2">Edit</button>
                    
                    
                
                </div>
              </div>
              <div id="desktop-inner-grid12">        <div class="row">
            
                  <b class="desktop-coupons-text2">Mobile Phone Number:</b>
                  <button class="desktop-ls2-button1">Cancel</button> <br/>
                  <a class="desktop-coupons-text2 ls1text1">Why Add Mobile Number?</a> 
                  <hr class="desktop-sa2-heading"></hr><br/>
                  <b>Add Mobile Number:</b><br/>
                  <a class="desktop-ls5-text3">Enter Your Mobile Number</a><br/>
                  <input type="desktop-login-text2" placeholder="+91 9773778575"></input><br/>
                   <a href="#popup4" ><button class="desktop-login-button2">Otp Verify To Save</button></a>
            
              </div>
              </div>
              <div id="desktop-inner-grid3">        <div class="row">
    
                  <b class="desktop-coupons-text2">Email:</b><br />
                  <a class="desktop-coupons-text2">shahnawaz.alam@jaypore.com</a>
        
              </div>
              </div>
              <div id="desktop-inner-grid4">        <div class="row">
                
                  <b class="desktop-coupons-text2">Password:</b><br/>
                  <b class="desktop-coupons-text2">********</b>
                  <button class="desktop-ls1-button2">Edit</button> 
              ...
              <div id="desktop-inner-grid4">        <div class="row">
                  ...
                  <b class="desktop-coupons-text2">Date of Birth:</b><br />
                  <a class="desktop-coupons-text2">DD/MM/YY</a>
                  <button class="desktop-ls1-button2">Edit</button> 
	...
	<div class="desktop-loginotp-popup">
    <a class="close1" href="#">×</a>
        <br/>
        <b class="desktop-ls6-text1">OTP Verification</b><br/>
        <a class="desktop-ls6-text2">Enter the OTP to verify your mobile number</a><br/>
        <b class="desktop-ls6-text3">9773778575</b><br/><br/><br/>
        <a class="desktop-ls6-text4">Enter OTP</a><br/><br/>
        <input type="desktop-loginotp-text" placeholder="5410" class="desktop-ls6-text5"/><br/>
        <a class="desktop-ls6-text6">1:59</a><br/><br/>
        <button class="desktop-loginotp-button2">Continue</button>
	</div>
...
export default Neeraj_Loginsecurity6