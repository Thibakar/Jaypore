...
class Neeraj_Loginsecurity8 extends React.Component {
    render(){
        return(
            <div>
                ...
                <div class="desktop-dob-grid"><br />
          <div class="desktop-dob-grid1"><br />
            <b class="desktop-coupons-text1">Login & Security</b>
            <hr class="desktop-sa2-heading"></hr>
            <div class="desktop-dob-grid2">
              <div id="desktop-innerlogin-grid1">
                <div class="row">
                 <img src={confirm} alt="img"></img>
                    <a class="desktop-coupons-text2 ls8text1" >Success</a><br />
                    <a class="desktop-coupons-text2 ls8text2" >Password has been modified</a>
              ...
              <div id="desktop-inner-grid2">        <div class="row">
                  ...
                  <b class="desktop-coupons-text2">Mobile Phone Number:</b><br />
                  <a class="desktop-coupons-text2 lstext1">Why Add Mobile Number?</a>
                  <button class="desktop-ls1-button2">Add</button> 
              ...
              <div id="desktop-inner-grid4">        <div class="row">
                  ...
                  <b class="desktop-coupons-text2">Date of Birth:</b>
                  ...
                  <input type="number"  class="desktop-ls8-input1" min="0" max="10" step="1" placeholder="01"></input>
                  <input type="number"   class="desktop-ls8-input1" min="0" max="10" step="1" placeholder="01"></input>
                  <input type="number"   class="desktop-ls8-input1" min="0" max="100" step="1" placeholder="1970"></input><br/><br/>
                  <button class="desktop-login-button1">Save Changes</button>
...
export default Neeraj_Loginsecurity8