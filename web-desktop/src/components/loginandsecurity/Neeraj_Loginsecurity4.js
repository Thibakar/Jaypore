...
class Neeraj_Loginsecurity4 extends React.Component {
    render(){
        return(
            <div>
          ...
          <div class="desktop-outer-grid1"><br />
            ...
            <div class="desktop-outer-grid2">
              ...
              <div id="desktop-inner-grid12">        <div class="row">
                  ...
                  <a class="desktop-ls4-text1">Enter Your Mobile Number</a><br/>
                  <input type="desktop-login-text2" placeholder="+91"></input><br/>
                    <button class="desktop-login-button1">Otp Verify To Save</button>
...
export default Neeraj_Loginsecurity4