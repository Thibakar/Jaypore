...
class HomeInspiredCanvas extends Component {
    render() {
        return (
            <div>
            <div className="div-rel" onClick={()=>this.props.props.history.push('/productListing')}>
                ...
                <h2 className="labletext position-absolute headingAlignmetAboveBanners pl-16 text-white">An Inspired Canvas</h2>
                        <p className="labletext position-absolute textAlignmetAboveBanners pl-16 text-white">Delicate earrings painted with motifs<br/>inspired by indian architecture and...</p>
            </div>
...
export default HomeInspiredCanvas
