...
import insaImg from '../../assets/Jaypore Assets/01 Icons/02 Home Page/Instagram.svg'
const customStyles = {
    overlay: {
        position: 'fixed',
        top: 0,
        ...
        return (
            <Modal
                ...
                <div>
                    ...
                    <div className='inst-head sticky' ref='insta-head'>
                        <span><img src={insaImg} className='insta-img' /></span>
                        Follow us on Instagram
                    </div>
                    <div className='bg-white'>
                        {
                            this.state.instaImgages.map((imgurl) => (
