...
class HomeGentleAndFluid extends Component {
    render() {
        return (
            <div>
               <div className="div-rel"  onClick={()=>this.props.props.history.push('/productListing')}>
                ...
                <h2 className="labletext position-absolute headingAlignmetAboveBanners pl-16 text-white">Gentle And Fluid</h2>
                        <p className="labletext position-absolute textAlignmetAboveBanners pl-16 text-white">Neutral-hued dresses, kurtas, tops with <br/>watercolor florals paired with drama...</p>
            </div>
...
export default HomeGentleAndFluid
