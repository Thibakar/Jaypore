...
export class termconditions extends Component {
    render() {
        return (
            <React.Fragment>
                <div>
                <div className="headerMenustyle01">
                    ...
                    <div className="trm-pol-cont-coxt">
                    <div className="terms_policymain_content">
                    <h5 className="returns_policytxt">Terms</h5>
                    <p className="termsjay-m-s-h-tag">Terms of Use Agreement</p>
                    <p> Welcome to Jaypore, the website and online service of Jaypore E-Commerce Pvt.Ltd.("Jaypore," "we," Or "us").
                    ...
                    Terms of Use (the "Agreement"), whether or not you are a registered user of our service. </p>
                    <p className="termsjay-m-s-h-tag">Use of Our Service</p>
                    <p> You may use the Service only if you can form a binding contract with Jaypore, and only in
                    ...
                    or obligations hereunder, except as expressly provided for in this Agreement, is void. </p>
                    <p className="termsjay-m-s-h-tag">Jaypore Accounts</p>
                    <p>The Service is available through Facebook's "Facebook Connect" service. [You must have 
                    ...
                    <p className="prohibited-a-ctivities"> You agree not to engage in any of the following prohibited activities in connection with the 
                                            Services:</p>
                      <div className="leftsideterm-condition">
                    ...
                    <p><span>(xii)</span> decompiling reverse engineering, or otherwise attempting to obtain the source code of the service.</p>
                      ...
                      <p> We may, without prior notice, change the Service, stop providing the Service or features of the Service<span>(to you or generally),</span> or create a usage 
                    ...
                    <p className="termsjay-m-s-h-tag">Copy Right & Intellectual Property</p>    
                    <p>All third party design featured on Jaypore are copyright and intellectual Property of their 
                     ...
                     <p className="termsjay-m-s-h-tag">User Content</p>    
                     <p>All third party design featured on Jaypore are copyright and intellectual Property of their 
                     respective designers and cannot be reproduced or transmitted in any form without the prior written permission of the designers. </p>   
                     <div className="leftsideterm-condition">
                     <p className="prohibited-a-ctivities"> You agree not to post user User Content that: </p>
                    ...
                    In connection with your User Content, you affirm ,represent and warrant the following:    
                     ...
                     <li className="mb-co-wv-pn"></li>
                    <p className="fb-tv-sz-m">  You have the written consent of each and every identifiable natural person in the User Content to use such person's name or likeness in the manner contemplated by the Service and this Agreement, each such person has released you from any liability that may arise in relation to such use. </p>
                    <li className="mb-co-wv-pn"></li>
                    <p className="fb-tv-sz-m">Jaypore may exercise the rights to your User Content that are granted to Jaypore under this Agreement, without payment of any guild fees, residuals, Payments, fees, or royalties payable under any collective bargaining agreement or otherwise.
                    ...
                    perform such User Content as permitted through the functionality of the Service and under this Agreement.</p>
                     ...
                     <p className="termsjay-m-s-h-tag">Jaypore Service</p>   
                     <p>We may make available software to access the Service via a mobile device<span>("Mobile Software ").</span> To use the Mobile Software you must have a 
                        ...
                        for one Jaypore account on one mobile device owned or leased solely by you,for your personal, non-commercial use. You may not:</p> 
                        <div className="leftsideterm-condition">
                        ...
                        <p className="termsjay-m-s-h-tag">Mobile Software from iTunes</p> 
                        <p className="prohibited-a-ctivities"> Our Property Rights </p>
                        ...
                        similar or related ideas previously known to Jaypore, or developed by its employees, or obtained from sources other than you.</p>
                        <p> Jaypore may provide Jaypore members referral credits when members invite their friends to join Jaypore ("Referral Credits" ). Referral
                        Credits may be awarded to the referrer when her friends join, as well as when her friends make their first purchases.</p>
                        ...
                        <p className="termsjay-m-s-h-tag">Billing Policies</p> 
                        <p>If you purchase an item through the Service, your purchase will be processed in accordance with the "orders" section of 
                        ...
                        with our Return Policy,all of which are incorporated herein by this reference.</p>
                        <p className="termsjay-m-s-h-tag">Payment Information: Taxes</p>
                        <p className="prohibited-a-ctivities"> Privacy </p>
                        ...
                        <p>Since we respect artist and content owner rights, it is Jaypore's policy  to respond to alleged infringement notices that  comply
                         with the Digital millennium Copyright Act of 1998 ("DMCA").</p>
                        ...
                        infringing,or the content provider, member or user believes that it has the right to post and use such material from the copyright
                            ...
                            <p>Email:<span><a href="mailto:hello@jaypore.com" className="email-jaypore_client"> hello@jaypore.com</a></span></p>
                        ...
                        <p><span>(vi)</span> any other party's access and use of the Service with your username, password or other appropriate security code. </p>
                         ...
                         <p>THE SERVICE AND ANY PRODUCT OR SERVICE YOU PURCHASE THROUGH THE SERVICE("PRODUCT") ARE PROVIDED ON AN "AS IS" AND 
                            ...
                            ANY DAMAGE TO YOUR COMPUTER SYSTEM OR LOSS OF DATA THAT RESULTS FROM SUCH DOWNLOAD OR YOUR USE OF THE SERVICE.</p>
                            <p className="termsjay-m-s-h-tag">Limitation of liability</p>   
                            ...
                            <p> The Service is controlled and operated from its facilities in the United States. Jaypore makes no representations that the Service is appropriate 
                                ...
                                <p className="termsjay-m-s-h-tag">Governing Law</p>
                                <p className="prohibited-a-ctivities"> Arbitration </p>
                                <p>Jaypore may provide notificaviations, whether such notifications are required by law or are for marketing or other business related 
                                    ...
                                    your network provider may apply to email notifications we send to the email address you provide us. We recommend that you add<span><a href="mailto:hello@jaypore.com" className="email-jaypore_client"> hello@jaypore.com</a></span> to your email address book to help ensure you receive email notifications from us.  
                                </p>
